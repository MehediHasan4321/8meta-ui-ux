            ...
            <div className="w-full h-full flex ">
                <div className="h-full w-3/5 flex flex-col gap-y-5 justify-center items-center">
                    <div>
                        ...
                        <div className="w-4/6 mt-10 text-lg text-secondary">
                ...
                <div className="w-2/5 h-full relative">
                    <Image src={'/images/company/company-bitmap2.png'} className="object-fill" fill alt="companybitmap" />
                </div>
            </div>
            <div className='w-full flex flex-col md:flex-row  justify-around gap-x-5 -mt-20'>
